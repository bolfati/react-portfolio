...
<div class="row justify-content-center m-3">
  <div className="col-sm-3 m-3"> <a href="https://bolfati.github.io/password-generator/"><img src="/assets/passwordgenerator.png" className="img-fluid" alt="picture of password generator application"></img></a></div>
  <div className="col-sm-3 m-3"> <a href="https://techblogapplicationdeploy-1a13907e686f.herokuapp.com/"><img src="/assets/techblog.png" className="img-fluid" alt="picture of tech blog posting application"></img></a></div>
  <div className="col-sm-3 m-3"> <a href="https://polar-reaches-24337-11935ec81b45.herokuapp.com/"><img src="/assets/notetakerapp.png" className="img-fluid" alt="picture of note taking application"></img></a></div>
